...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a Fréchet distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( shape: Shape, alpha: number | T, s: number | U, m: number | V, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a Fréchet distribution.
	*
	* @param alpha - shape parameter
	* @param s - scale parameter
	* @param m - location parameter
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>, W extends typedndarray<number>>( alpha: number | T, s: number | U, m: number | V, out: W ): W;
}
...
interface Random extends PRNG {
	...
	*
	* @example
	* var out = frechet( [ 3, 3 ], 2.0, 5.0, 3.0 );
	* // returns <ndarray>
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( shape: Shape, alpha: number | T, s: number | U, m: number | V, options?: Options ): RandomArray;
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a Fréchet distribution.
	*
	* @param options - function options
